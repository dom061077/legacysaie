	...
	<body>
		...
		<div id="show-provincia" class="content scaffold-show" role="main">
			...
			<ol class="property-list provincia">
				...
				<g:if test="${provinciaInstance?.descripcion}">
				<li class="fieldcontain">
					<span id="descripcion-label" class="property-label"><g:message code="provincia.descripcion.label" default="Descripcion" /></span>
					
						<span class="property-value" aria-labelledby="descripcion-label"><g:fieldValue bean="${provinciaInstance}" field="descripcion"/></span>
